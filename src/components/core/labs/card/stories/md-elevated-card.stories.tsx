...
import { MdElevatedCard, MdElevatedCardProps } from '..'

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta = {
    title: 'Material You/Card/Elevated Card',
    component: MdElevatedCard,
    parameters: {
    ...
    args: {},
} satisfies Meta<MdElevatedCardProps>
...
export const Detault: Story = {
    ...
    render: () => (
        ...
        >
            <MdElevatedCard style={{ width: '320px' }}>
                <img
                    src={MEDIA_IMAGE}
