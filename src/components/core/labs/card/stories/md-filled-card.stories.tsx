...
import { MdFilledCard, MdFilledCardProps } from '..'

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta = {
    title: 'Material You/Card/Filled Card',
    component: MdFilledCard,
    parameters: {
    ...
    args: {},
} satisfies Meta<MdFilledCardProps>
...
export const Detault: Story = {
    ...
    render: () => (
        ...
        >
            <MdFilledCard style={{ width: '320px' }}>
                <img
                    src={MEDIA_IMAGE}
