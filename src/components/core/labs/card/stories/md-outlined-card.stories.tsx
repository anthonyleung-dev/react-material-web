...
import { MdOutlinedCard, MdOutlinedCardProps } from '..'

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta = {
    title: 'Material You/Card/Outlined Card',
    component: MdOutlinedCard,
    parameters: {
    ...
    args: {},
} satisfies Meta<MdOutlinedCardProps>
...
export const Detault: Story = {
    ...
    render: () => (
        ...
        >
            <MdOutlinedCard style={{ width: '320px' }}>
                <img
                    src={MEDIA_IMAGE}
