...
import { MdFilledTonalButton, MdFilledTonalButtonProps } from '..'
import { MdIcon } from '../../icon'

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta = {
    title: 'Material You/Buttons/Filled Tonal Button',
    ...
    argTypes: {
        children: {
            ...
            defaultValue: 'FilledTonal Button',
        },
        disabled: {
            control: 'boolean',
            defaultValue: false,
...
} satisfies Meta<MdFilledTonalButtonProps>
